...
<div class="max-h-64 overflow-y-auto rounded-lg border border-base-300/50 bg-base-200/30">
	...
	{:else if $folderTreeQuery.data}
		...
		>
			...
			{#if currentFolderId === null}
				<span class="ml-auto rounded-full bg-base-300/50 px-2 py-0.5 text-xs text-base-content/60"
					>Current</span
				>
			{/if}
		</button>

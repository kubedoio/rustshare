...
<ModalBase {open} title="Empty Trash?" onClose={handleClose}>
	<div class="space-y-3 py-4">
		<p class="text-base-content/80">
			This will permanently delete all items in your trash. This action cannot be undone.
		</p>

		<div class="space-y-1.5 rounded-lg bg-base-200 p-3">
			...
			<div class="flex justify-between border-t border-base-300/60 pt-1.5 text-sm">

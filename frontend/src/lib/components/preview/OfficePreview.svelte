...
<div class="flex flex-col items-center justify-center p-12 text-center">
	{#if file && config}
		<div class="w-24 h-24 rounded-2xl {config.bgColor} flex items-center justify-center mb-6" aria-label="{config.label} icon">
	...
	{:else if file}
		<div class="w-20 h-20 rounded-2xl bg-base-300 flex items-center justify-center mb-4" aria-label="Office document">

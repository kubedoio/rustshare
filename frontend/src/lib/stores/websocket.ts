...
export const isWebSocketConnected = derived(websocketStore, ($ws) => $ws.state === 'connected');

export const websocketConnectionState = derived(websocketStore, ($ws) => $ws.state);

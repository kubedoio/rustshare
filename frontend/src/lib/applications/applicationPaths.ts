 ...
 * - Write canonical: all new creates write exclusively to /Workspace/<Application>.
 ...
 * Example: getApplicationRoot("Notes") → "/Workspace/Notes"
 */
export function getApplicationRoot(moduleName: string): string {
 ...
 * Example: getLegacyApplicationRoot("Notes") → "/Notes"
 */
export function getLegacyApplicationRoot(moduleName: string): string {
	return `/${moduleName}`;
}

/**
 * Canonical write path for a module.
 * Alias for getApplicationRoot; explicitly documents write policy.
 */
export function getCanonicalWritePath(moduleName: string): string {
	return getApplicationRoot(moduleName);
}
 ...
 */
export function isLegacyApplicationRoot(path: string): boolean {
 ...
 */
export function getApplicationPathVariants(moduleName: string): {
	workspace: string;
	legacy: string;
} {
	return {
		workspace: getApplicationRoot(moduleName),
		legacy: getLegacyApplicationRoot(moduleName)
	};
}
 ...
 */
export function getApplicationReadPaths(moduleName: string): string[] {
	return [getCanonicalWritePath(moduleName), getLegacyApplicationRoot(moduleName)];
}

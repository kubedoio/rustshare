...
>
	...
	{#if !compact}
		...
		{#if badge !== null && badge > 0}
			<span
				class="ml-auto inline-flex h-5 min-w-[1.25rem] flex-shrink-0 items-center justify-center rounded-full bg-brand-500 px-1.5 text-xs font-semibold text-white"
			>
				{badge > 99 ? '99+' : badge}
			</span>
		{/if}
